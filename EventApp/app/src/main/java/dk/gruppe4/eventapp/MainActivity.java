        ...
        ActivitiesFragment.OnFragmentInteractionListener
{
    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        switch (position){
            ...
            case 0:
                 Fragment news = new NewsFeedFragment();
            ...
            case 1:
                ...
                fragmentManager.beginTransaction()
                        .replace(R.id.container, activities)
                        .commit();
                mTitle = "Aktiviteter";
                break;
            ...
            case 3:
                Fragment myActivities = new MyActivitiesFragment();
                fragmentManager.beginTransaction()
                        .replace(R.id.container, myActivities)
                        .commit();
                mTitle = "Mine aktiviteter";
                break;

            case 4:
                Fragment attended = new AttendedFragment();
                fragmentManager.beginTransaction()
                        .replace(R.id.container, attended)
                        .commit();
                mTitle = "Deltaget i";
                break;
